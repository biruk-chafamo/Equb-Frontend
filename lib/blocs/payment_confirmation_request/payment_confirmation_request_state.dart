...
class PaymentConfirmationRequestState extends Equatable {
  ...
  List<Object?> get props => [
        ...
        selectedPaymentConfirmationRequest,
        equbId,
        error
      ];
  ...
  PaymentConfirmationRequestState copyWith({
    ...
    return PaymentConfirmationRequestState(
      ...
      paymentConfirmationRequests:
          paymentConfirmationRequests ?? this.paymentConfirmationRequests,
      selectedPaymentConfirmationRequest: selectedPaymentConfirmationRequest ??
          this.selectedPaymentConfirmationRequest,
