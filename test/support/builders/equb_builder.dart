...
EqubDetail buildEqubDetail({
  ...
  List<User>? rejectedPayers,
  List<User>? confirmedPayers,
  List<User>? unconfirmedPayers,
  List<User>? unpaidMembers,
  ...
  return EqubDetail(
    ...
    rejectedPayers: rejectedPayers ?? const [],
    confirmedPayers: confirmedPayers ?? const [],
    unconfirmedPayers: unconfirmedPayers ?? const [],
    unpaidMembers: unpaidMembers ?? const [],
